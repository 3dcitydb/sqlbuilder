...
public class Sets {
    ...
    public static SetOperator intersect(List<Select> operands) {
        return SetOperator.of(SetOperationType.INTERSECT, operands);
    }
    ...
    public static SetOperator union(List<Select> operands) {
        return SetOperator.of(SetOperationType.UNION, operands);
    }
    ...
    public static SetOperator unionAll(List<Select> operands) {
        return SetOperator.of(SetOperationType.UNION_ALL, operands);
    }
